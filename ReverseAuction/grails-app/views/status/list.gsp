			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="category" title="${message(code: 'status.category.label', default: 'Category')}" />
				...
				<g:each in="${statusInstanceList}" status="i" var="statusInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${statusInstance.id}">${fieldValue(bean: statusInstance, field: "category")}</g:link></td>
